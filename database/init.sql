...
CREATE TABLE member_enrollment (
    ...
    plan_code VARCHAR(10) DEFAULT 'DEFAULT',
    product_code VARCHAR(15) DEFAULT 'PROD_HMO_001',
    status VARCHAR(20) DEFAULT 'ACTIVE',
    primary_care_provider_id VARCHAR(20),
    coverage_effective_date DATE DEFAULT CURRENT_DATE,
...
CREATE TABLE provider_network (
    ...
    npi_number VARCHAR(10) UNIQUE DEFAULT '0000000000',
    provider_name VARCHAR(100) DEFAULT 'Unknown Provider',
    provider_type VARCHAR(50) DEFAULT 'Primary Care',
    specialty VARCHAR(100) DEFAULT 'General',
    product_code VARCHAR(15) DEFAULT 'PROD_HMO_001',
    network_tier VARCHAR(20) DEFAULT 'Tier 2',
